									...
									<div class="container">
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<label class="radio">
														<input type="radio" data-toggle="radio" name="jenis_kelamin" id="jenis_kelamin1" value="laki-laki" data-radiocheck-toggle="radio" <?php if ($jenis_kelamin=="laki-laki"): ?> checked="" <?php endif ?> class="custom-radio"><span class="icons"><span class="icon-unchecked"></span><span class="icon-checked"></span></span>
														Laki-laki
													</label>
													<label class="radio">
														<input type="radio" data-toggle="radio" name="jenis_kelamin" id="jenis_kelamin2" value="perempuan" data-radiocheck-toggle="radio" <?php if ($jenis_kelamin=="perempuan"): ?> checked="" <?php endif ?> class="custom-radio"><span class="icons"><span class="icon-unchecked"></span><span class="icon-checked"></span></span>
														Perempuan
													</label>
												</div>
											</div>
									...
									<div class="container">
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="nama_pasangan" id="nama_pasangan" class="form-control" placeholder="Nama Pasangan" value="<?php echo $nama_pasangan ?>">
												</div>
											</div>
											<!-- Nama Anak -->
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													...
													<?php 
													if ($nama_anak!="") {
														if (strpos($nama_anak, "|")!==FALSE) {
															$nama_anak_explode = explode("|", $nama_anak);
															for ($i=0; $i < count($nama_anak_explode); $i++) { 
																if ($i==0) {
																	?>
																	<input type="text" name="nama_anak[]" class="form-control" placeholder="Nama Anak" value="<?php echo $nama_anak_explode[$i]; ?>">
															...
															for ($i=0; $i < count($nama_anak_explode); $i++) { 
																...
																if ($i>0) {
																	...
																	<div id='remove_<?php echo $rem_ext_id ?>'>
																		...
																		<input type='text' name='nama_anak[]' class='form-control' placeholder='Nama Anak' value="<?php echo $nama_anak_explode[$i]; ?>">
																		<span class='input-group-btn'>
																			<button type='button' class='btn btn-default' onclick="hapus_nama_anak('<?php echo $rem_ext_id ?>')">Hapus</button>
																		</span>
																		</div>
																		<p></p>
																	</div>
