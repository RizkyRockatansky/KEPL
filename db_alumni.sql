...
--
-- Host: 127.0.0.1
-- Generation Time: 07 Okt 2019 pada 15.23
-- Versi Server: 5.6.24
-- PHP Version: 5.6.8
...
--
-- Struktur dari tabel `aluni_anggota_akademik`
--

CREATE TABLE IF NOT EXISTS `aluni_anggota_akademik` (
...
--
-- Dumping data untuk tabel `aluni_anggota_akademik`
--
...
(1, '', 0, 0, '', '', 'admin', '2017-02-17 10:43:52', 'admin', '2019-09-15 20:44:31', 3),
(2, '', 0, 0, '', '', 'admin', '2019-09-15 21:22:42', 'admin', '2019-09-15 21:22:42', 0),
(3, '', 0, 0, '', '', 'admin', '2019-09-15 21:23:46', 'admin', '2019-09-15 21:23:46', 0),
(4, '201', 200, 200, '9', '<p>re</p>', 'admin', '2019-09-15 21:26:50', 'admin', '2019-09-15 21:26:50', 0),
(5, '234', 234, 324, '234', '<p>ww</p>', 'admin', '2019-09-15 21:38:44', 'admin', '2019-09-15 21:38:44', 0),
(6, '23', 234, 23, '2', '<p>e</p>', 'admin', '2019-09-15 21:41:05', 'admin', '2019-09-15 21:41:05', 0),
(8, '', 0, 0, '', '', 'admin', '2019-09-23 19:33:02', 'admin', '2019-09-23 19:33:02', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `aluni_anggota_dasar`
--

CREATE TABLE IF NOT EXISTS `aluni_anggota_dasar` (
  `id_anggota` int(12) NOT NULL,
...
--
-- Dumping data untuk tabel `aluni_anggota_dasar`
--
...
(2, 'hehe', 'hahaw', 'laki-laki', 'Kabupaten Gayo Lues', '2019-09-12', '1', 0x68616861772e6a7067, 2, 25, '<p>p</p>', 'tidak', 'admin', '2019-09-15 21:22:41', 'admin', '2019-09-15 21:22:41', 0),
(3, 'hihi', 'hihi', 'laki-laki', 'Kabupaten Aceh Barat', '2019-08-28', '1', 0x686968692e6a7067, 1, 0, '<p>gg</p>', 'tidak', 'admin', '2019-09-15 21:23:46', 'admin', '2019-09-15 21:23:46', 0),
(4, 'jbnl', 'jbnl', 'laki-laki', 'Kabupaten Pidie', '2019-09-06', '1', 0x6e6f2d696d672e6a7067, 5, 0, '<p>nnn</p>', 'ya', 'admin', '2019-09-15 21:26:50', 'admin', '2019-09-15 21:26:50', 0),
(5, 'haha', 'haha', 'laki-laki', 'Kabupaten Nagan Raya', '2019-09-10', '1', 0x686168612e6a7067, 2, 26, '<p>papa</p>', 'ya', 'admin', '2019-09-15 21:38:44', 'admin', '2019-09-15 21:38:44', 0),
(6, 'asdasd', 'asdasdqew', 'laki-laki', 'Kabupaten Aceh Barat', '2019-08-27', '1', 0x6e6f2d696d672e6a7067, 1, 0, '<p>ww</p>', 'ya', 'admin', '2019-09-15 21:41:05', 'admin', '2019-09-15 21:41:05', 0),
(7, 'asdasd', 'asdasdqew', 'laki-laki', 'Kabupaten Aceh Barat', '2019-08-27', '1', 0x6e6f2d696d672e6a7067, 1, 0, '<p>ww</p>', 'ya', 'admin', '2019-09-15 21:41:05', 'admin', '2019-09-15 21:41:05', 0),
(8, 'Harsa Yamani', 'harsay', 'laki-laki', 'Kota Cirebon', '1999-03-23', '1', 0x6861727361792e706e67, 12, 182, '', 'ya', 'admin', '2019-09-23 19:33:02', 'admin', '2019-09-23 19:33:02', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `aluni_anggota_keluarga`
--

CREATE TABLE IF NOT EXISTS `aluni_anggota_keluarga` (
...
--
-- Dumping data untuk tabel `aluni_anggota_keluarga`
--
...
(1, '', '', 'admin', '2017-02-17 10:43:52', 'admin', '2019-09-15 20:44:31', 3),
(2, '', '', 'admin', '2019-09-15 21:22:42', 'admin', '2019-09-15 21:22:42', 0),
(3, '', '', 'admin', '2019-09-15 21:23:46', 'admin', '2019-09-15 21:23:46', 0),
(4, 'jj', '88', 'admin', '2019-09-15 21:26:50', 'admin', '2019-09-15 21:26:50', 0),
(5, '', '', 'admin', '2019-09-15 21:38:44', 'admin', '2019-09-15 21:38:44', 0),
(6, '', '', 'admin', '2019-09-15 21:41:05', 'admin', '2019-09-15 21:41:05', 0),
(8, '', '', 'admin', '2019-09-23 19:33:02', 'admin', '2019-09-23 19:33:02', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `aluni_anggota_kontak`
--

CREATE TABLE IF NOT EXISTS `aluni_anggota_kontak` (
  `id_anggota` int(12) NOT NULL,
...
--
-- Dumping data untuk tabel `aluni_anggota_kontak`
--
...
(1, '', '', '', '', '', 'http://sedotcode.blogspot.co.id/', '', '', 'admin', '2017-02-17 10:43:52', 'admin', '2019-09-15 20:44:31', 3),
(2, '', '', '', '', '', '', '', '', 'admin', '2019-09-15 21:22:42', 'admin', '2019-09-15 21:22:42', 0),
(3, '', '', '', '', '', '', '', '', 'admin', '2019-09-15 21:23:46', 'admin', '2019-09-15 21:23:46', 0),
(4, '235423', '234', '324', '234', 'dsg', 'sd', '', 'sdsg', 'admin', '2019-09-15 21:26:50', 'admin', '2019-09-15 21:26:50', 0),
(5, '3223422323', '234', '234', '', 'werew', 'werwr', '', '', 'admin', '2019-09-15 21:38:44', 'admin', '2019-09-15 21:38:44', 0),
(6, '1123', '213', '213', '', 'sdf', 'sef', '', '', 'admin', '2019-09-15 21:41:05', 'admin', '2019-09-15 21:41:05', 0),
(8, '', '', '', '', '', '', '', '', 'admin', '2019-09-23 19:33:02', 'admin', '2019-09-23 19:33:02', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `aluni_anggota_orang_tua`
--

CREATE TABLE IF NOT EXISTS `aluni_anggota_orang_tua` (
  `id_anggota` int(12) NOT NULL COMMENT 'FK member_basic_info',
...
--
-- Dumping data untuk tabel `aluni_anggota_orang_tua`
--
...
(2, '', '', '', 0, 0, '', 'admin', '2019-09-15 21:22:42', 'admin', '2019-09-15 21:22:42', 0),
(3, '', '', '', 0, 0, '', 'admin', '2019-09-15 21:23:46', 'admin', '2019-09-15 21:23:46', 0),
(4, 'gg', 'wp', '', 2, 0, '<p>pp</p>', 'admin', '2019-09-15 21:26:50', 'admin', '2019-09-15 21:26:50', 0),
(5, 'ayah', 'ibu', '', 2, 25, '<p>hewhe</p>', 'admin', '2019-09-15 21:38:44', 'admin', '2019-09-15 21:38:44', 0),
(6, 'qwe', 'qwe', 'qwe', 2, 0, '<p>22</p>', 'admin', '2019-09-15 21:41:05', 'admin', '2019-09-15 21:41:05', 0),
(8, '', '', '', 0, 0, '', 'admin', '2019-09-23 19:33:02', 'admin', '2019-09-23 19:33:02', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `aluni_m_agama`
--

CREATE TABLE IF NOT EXISTS `aluni_m_agama` (
...
--
-- Dumping data untuk tabel `aluni_m_agama`
--
...
--
-- Struktur dari tabel `aluni_m_kota`
--

CREATE TABLE IF NOT EXISTS `aluni_m_kota` (
  `id_provinsi` int(4) NOT NULL,
  `id_kota` int(4) NOT NULL,
...
--
-- Dumping data untuk tabel `aluni_m_kota`
--
...
--
-- Struktur dari tabel `aluni_m_modul`
--

CREATE TABLE IF NOT EXISTS `aluni_m_modul` (
...
--
-- Dumping data untuk tabel `aluni_m_modul`
--
...
--
-- Struktur dari tabel `aluni_m_provinsi`
--

CREATE TABLE IF NOT EXISTS `aluni_m_provinsi` (
  `id_provinsi` int(4) NOT NULL,
...
--
-- Dumping data untuk tabel `aluni_m_provinsi`
--
...
--
-- Struktur dari tabel `aluni_pengaturan`
--

CREATE TABLE IF NOT EXISTS `aluni_pengaturan` (
...
--
-- Dumping data untuk tabel `aluni_pengaturan`
--
...
--
-- Struktur dari tabel `aluni_pengguna`
--

CREATE TABLE IF NOT EXISTS `aluni_pengguna` (
...
--
-- Dumping data untuk tabel `aluni_pengguna`
--
...
('asdasdqew', '18aa3dace348f9c054f13fcc78f05393544feae271bb147799bf61af78cd13bafe4e10516c5918f8555dc869f2b8b87f20b7db773e758d654d9b4849fbd569bc', 'a71cf4226137cec98b12a824182db70bbfa9371f820b8309bed6b4c7335df374', 'user', 'ya', 'asdasd', '', 'no-img.jpg', 6, 'admin', '2019-09-15 21:41:05', 'admin', '2019-09-15 21:41:05', 0),
('haha', 'c4d7130e1867211c6fed9a1e81aed7c270d4e75f4d707bd2a2e6670498acff0c318dd7e1ea53fd8dae867d0110048f5acf80cfca77d0927731446e89f9bdac59', 'f93c31014b468d64d81a13de854a731888f95f2a9f365e5449fec74c413c8bf3', 'user', 'ya', 'haha', '', 'haha.jpg', 5, 'admin', '2019-09-15 21:38:44', 'admin', '2019-09-15 21:38:44', 0),
('hahaw', 'b1611ee6445c32aaa40b70d5ed944112bcb253522acfeea85a970786762b3db32b319f6c8db2a1850fd3189ec92c279d3a4e90d504d0c90fe4eb45c2fc03fa15', 'b6d66f7ea9fea4e7f1e764a2a9fca45aed37b70102348560f66fed2b9f623a83', 'user', 'ya', 'hehe', '', 'hahaw.jpg', 2, 'admin', '2019-09-15 21:22:41', 'admin', '2019-09-15 21:22:41', 0),
('harsay', 'a0549f41e3c9b4275cf9b04cbaf70dd8cc9ee365ddb34f85f087069b8cd5aac95599d8b1ce6fbbde4788bb8b1d1bf1a93e5112d2c00f2ce099977c1c5e6c5afe', 'c260c3bbf884e315f715f00bc052c8f78f1e00fc5c961d039da3d0766711e596', 'user', 'ya', 'Harsa Yamani', '', 'harsay.png', 8, 'admin', '2019-09-23 19:33:02', 'admin', '2019-09-23 19:33:02', 0),
('hihi', '291337ac359c11f1ae40a0ea94ce4672f82ebf37bb7f946ac5a3526a408c8dabcc28585c02799f31ace00d9a4da4396e6f39a4244f9b07f518956cfcdd791dd8', '58b48ae668b8b9b0419f88741e06b6241f4abc7de08ff3a7a05718bcd177867c', 'user', 'ya', 'hihi', '', 'hihi.jpg', 3, 'admin', '2019-09-15 21:23:46', 'admin', '2019-09-15 21:23:46', 0),
('jbnl', 'c65172986473bae320302a66fcdb2517cb9fd18deb375a967b1587a108a7f3a1f6c39ebc536213d082657302a7ab1a79a2278bf1847f8af42b47a8e4fd80fea0', 'edecdc4517928412ececc83136855f619842cabbc30e5e73f29f98cc87edcb16', 'user', 'ya', 'jbnl', '', 'no-img.jpg', 4, 'admin', '2019-09-15 21:26:50', 'admin', '2019-09-15 21:26:50', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `aluni_pengguna_hak_akses`
--

CREATE TABLE IF NOT EXISTS `aluni_pengguna_hak_akses` (
...
--
-- Dumping data untuk tabel `aluni_pengguna_hak_akses`
--

INSERT INTO `aluni_pengguna_hak_akses` (`username`, `hak_akses`, `created_date`) VALUES
('admin', '*', '2016-01-28 10:04:05'),
('asdasdqew', '', '2019-09-15 21:41:05'),
('haha', '', '2019-09-15 21:38:44'),
('hahaw', '', '2019-09-15 21:22:41'),
('harsay', '', '2019-09-23 19:33:02'),
('hihi', '', '2019-09-15 21:23:46'),
('jbnl', '', '2019-09-15 21:26:50'),
('sedotcode', '', '2017-02-17 10:43:52');

-- --------------------------------------------------------

--
-- Struktur dari tabel `aluni_pengguna_status_password`
--

CREATE TABLE IF NOT EXISTS `aluni_pengguna_status_password` (
  `id_anggota` int(12) NOT NULL,
  `username` varchar(30) NOT NULL,
...
--
-- Dumping data untuk tabel `aluni_pengguna_status_password`
--
...
(2, 'hahaw', '315affe5', 'belum diubah', 'admin', '2019-09-15 21:22:41', 'admin', '2019-09-15 21:22:41'),
(3, 'hihi', '5b8edb89', 'belum diubah', 'admin', '2019-09-15 21:23:46', 'admin', '2019-09-15 21:23:46'),
(4, 'jbnl', '830dc272', 'belum diubah', 'admin', '2019-09-15 21:26:50', 'admin', '2019-09-15 21:26:50'),
(5, 'haha', 'c25eefe0', 'belum diubah', 'admin', '2019-09-15 21:38:44', 'admin', '2019-09-15 21:38:44'),
(6, 'asdasdqew', 'a2df1f48', 'belum diubah', 'admin', '2019-09-15 21:41:05', 'admin', '2019-09-15 21:41:05'),
(8, 'harsay', 'admin', 'belum diubah', 'admin', '2019-09-23 19:33:02', 'admin', '2019-09-23 19:33:02');
...
--
CREATE TABLE IF NOT EXISTS `aluni_v_anggota_lengkap` (
`id_anggota` int(12)
...
--
CREATE TABLE IF NOT EXISTS `aluni_v_anggota_mentah` (
`id_anggota` int(12)
,`nama_lengkap` varchar(100)
,`nama_panggilan` varchar(50)
,`jenis_kelamin` enum('laki-laki','perempuan')
...
--
CREATE TABLE IF NOT EXISTS `aluni_v_pengguna` (
`username` varchar(30)
...
--
-- Struktur untuk view `aluni_v_anggota_lengkap`
--
DROP TABLE IF EXISTS `aluni_v_anggota_lengkap`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aluni_v_anggota_lengkap` AS select `ad`.`id_anggota` AS `id_anggota`,`ad`.`nama_lengkap` AS `nama_lengkap`,`ad`.`nama_panggilan` AS `nama_panggilan`,`ad`.`jenis_kelamin` AS `jenis_kelamin`,`ad`.`tempat_lahir` AS `tempat_lahir`,`ad`.`tanggal_lahir` AS `tanggal_lahir`,(select `aluni_m_agama`.`nama_agama` AS `nama_agama` from `aluni_m_agama` where (`aluni_m_agama`.`id_agama` = `ad`.`agama`)) AS `agama`,`ad`.`foto` AS `foto`,(select `aluni_m_provinsi`.`nama_provinsi` AS `nama_provinsi` from `aluni_m_provinsi` where (`aluni_m_provinsi`.`id_provinsi` = `ad`.`id_provinsi`)) AS `provinsi`,(select `aluni_m_kota`.`nama_kota` AS `nama_kota` from `aluni_m_kota` where (`aluni_m_kota`.`id_kota` = `ad`.`id_kota`)) AS `kota`,`ad`.`alamat` AS `alamat`,`ad`.`aktif` AS `aktif`,`aa`.`angkatan` AS `angkatan`,`aa`.`tahun_masuk` AS `tahun_masuk`,`aa`.`tahun_keluar` AS `tahun_keluar`,`aa`.`kelas_terakhir` AS `kelas_terakhir`,`aa`.`catatan` AS `catatan`,`ak`.`nama_pasangan` AS `nama_pasangan`,`ak`.`nama_anak` AS `nama_anak`,`ao`.`nama_ayah` AS `nama_ayah`,`ao`.`nama_ibu` AS `nama_ibu`,`ao`.`nama_wali` AS `nama_wali`,(select `aluni_m_provinsi`.`nama_provinsi` AS `nama_provinsi` from `aluni_m_provinsi` where (`aluni_m_provinsi`.`id_provinsi` = `ao`.`id_provinsi`)) AS `provinsi_orang_tua`,(select `aluni_m_kota`.`nama_kota` AS `nama_kota` from `aluni_m_kota` where (`aluni_m_kota`.`id_kota` = `ao`.`id_kota`)) AS `kota_orang_tua`,`ao`.`alamat_orang_tua` AS `alamat_orang_tua`,`ako`.`no_rumah` AS `no_rumah`,`ako`.`no_handphone` AS `no_handphone`,`ako`.`no_handphone2` AS `no_handphone2`,`ako`.`pin_blackberry` AS `pin_blackberry`,`ako`.`alamat_email` AS `alamat_email`,`ako`.`alamat_website` AS `alamat_website`,`ako`.`facebook` AS `facebook`,`ako`.`twitter` AS `twitter` from ((((`aluni_anggota_dasar` `ad` join `aluni_anggota_akademik` `aa` on((`ad`.`id_anggota` = `aa`.`id_anggota`))) join `aluni_anggota_keluarga` `ak` on((`ad`.`id_anggota` = `ak`.`id_anggota`))) join `aluni_anggota_orang_tua` `ao` on((`ad`.`id_anggota` = `ao`.`id_anggota`))) join `aluni_anggota_kontak` `ako` on((`ad`.`id_anggota` = `ako`.`id_anggota`)));

-- --------------------------------------------------------

--
-- Struktur untuk view `aluni_v_anggota_mentah`
--
...
--
-- Struktur untuk view `aluni_v_pengguna`
--
...
--
ALTER TABLE `aluni_anggota_dasar`
  MODIFY `id_anggota` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
